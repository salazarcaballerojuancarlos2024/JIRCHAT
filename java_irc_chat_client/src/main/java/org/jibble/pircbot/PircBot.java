...
public abstract class PircBot implements ReplyConstants {
    ...
    public final synchronized void connect(String hostname, int port, String password) throws IOException, IrcException, NickAlreadyInUseException {
        ...
        OutputThread.sendRawLine(this, bwriter, "USER " + this.getLogin() + " 8 * :" + this.getName());
    ...
    protected void handleLine(String line) {
        this.log(line);
        System.out.println("--- RECEPTOR RECIBE LINEA: " + line);
        ...
        if (command.equals("PRIVMSG") && line.indexOf(":\u0001") > 0 && line.endsWith("\u0001")) {
         ...
         // ⭐ LOG CRÍTICO AQUÍ: ¿QUÉ RECIBIMOS?
            System.out.println("--- DEBUG CTCP RECIBIDO ---");
            System.out.println("--- DESDE RECEPTOR FULL LINE: " + line);
            System.out.println("--- DESDE RECEPTOR COMMAND: " + command); // Debería ser PRIVMSG
            System.out.println("--- DESDE RECEPTOR REQUEST: " + request); // Lo que debería ser 'DCC SEND...'
            ...
            if (request.equals("VERSION")) {
            	...
            	System.out.println("DEBUG DCC HIT: Desde Receptor -- Request: " + request);
